			...
			{user ? (
				<>
					...
					<div className='flex items-center'>
						...
						<div className='xs:flex justify-center items-center mx-4 cursor-pointer'>
							<span className='text-[14px] m-0 p-0'>Raghav Goel</span>
							&nbsp;&nbsp;
				...
				<>
					...
					<div className='flex justify-between items-center gap-8'>
						<Link to='/login' className='p-2 px-6 rounded-full bg-[#5C8D7B] font-bold tracking-wide text-sm'>Login</Link>
						<Link to='/register' className='p-2 px-6 rounded-full bg-[#5C8D7B] font-bold tracking-wide text-sm'>Register</Link>
					</div>
				</>
			)}
		</nav>
